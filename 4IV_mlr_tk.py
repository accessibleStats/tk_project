...
Multiple Regressions Estimation (4) Independent Variables (with decimals))
...
x3_varLabel=tk.Label(mlwindow, text="Enter the values for X3:", pady=10, padx=30, relief=tk.RAISED, borderwidth=15) 
x4_varLabel=tk.Label(mlwindow, text="Enter the values for X4:", pady=10, padx=30, relief=tk.RAISED, borderwidth=15)  
...
x3_varnum=tk.Entry(mlwindow, textvariable=x3_varnum, relief=tk.RAISED, bd=5, borderwidth=15)
x4_varnum=tk.Entry(mlwindow, textvariable=x3_varnum, relief=tk.RAISED, bd=5, borderwidth=15)
